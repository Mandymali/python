...
>>> values['username']="2587418667@qq.com"
>>> values['password']=
SyntaxError: invalid syntax
>>> values['password']="mandy*@mali1314"
>>> data = urllib.urlencode(values)
>>> url = "http://passport.csdn.net/account/login"
>>> geturl = url + "?"+data
>>> reauest = urllib2.Request(geturl)
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=E1D276741B43B2C0A4312DC43C6A3B33.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=E1D276741B43B2C0A4312DC43C6A3B33.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=E1D276741B43B2C0A4312DC43C6A3B33.tomcat1" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=E1D276741B43B2C0A4312DC43C6A3B33.tomcat1?username=2587418667%40qq.com&amp;password=mandy%2A%40mali1314" method="post">
					...
					<input type="hidden" name="lt" value="LT-310794-RfFfD4yoSUq6he0hHLMV066YFND97G" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=E1D276741B43B2C0A4312DC43C6A3B33.tomcat1"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=E1D276741B43B2C0A4312DC43C6A3B33.tomcat1" src="/js/libs/require.js;jsessionid=E1D276741B43B2C0A4312DC43C6A3B33.tomcat1"></script>
    <script type="text/javascript">
